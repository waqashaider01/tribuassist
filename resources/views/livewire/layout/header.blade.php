<div class="sticky top-0 flex justify-between items-center px-6 py-4 bg-blue-900 md:bg-white border-b">
    ...
    <div class="flex items-center gap-2">
        ...
        <div class="flex items-center gap-2">
            <div
                class="profile-photo-circle rounded-full overflow-hidden h-[56px] w-[56px] flex justify-center items-center">
                <button
                    class="h-12 w-12 flex justify-center items-center bg-blue-900 text-white rounded-full overflow-hidden ring-2 ring-offset-2"
                    title="{{$user->name}}">
                    @if($avatar)
                    <img src="{{$avatar}}" alt="{{$name_shortcode}}">
                    @else
                    {{$name_shortcode}}
                    @endif
                </button>
